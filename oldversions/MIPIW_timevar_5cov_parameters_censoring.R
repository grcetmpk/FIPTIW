...
source("MIPIW_timevar_5cov_functions_censoring.R")
# 
...
#### Perform a single simulation as a test
# test <- simulateResultsMIPI_timevar_5cov_censoring(N, n, beta1, beta2, beta3, beta4, beta5,
...
## Simulate all possible combinations, create table
## Full results are saved for each simulation for plotting
...
# results_5cov_censoring <- simulateALLMIPI_timevar_5cov_censoring(N, n, beta1, beta2, beta3, beta4, beta5,
#                                                                              gamma1, gamma2, gamma3, gamma4, gamma5,
#                                                                              kappa1, kappa2, kappa3, kappa4, kappa5,
#                                                                              alpha0, alpha1, alpha2, tau)
# saveRDS(results_5cov_censoring, "results_5cov_censoring.rds")
results_5cov_censoring <- readRDS("results_5cov_censoring.rds")

kable(results_5cov_censoring$resultsmat, booktabs = T, digits = 3,format = "latex") %>%
  add_header_above(c(" " = 4, "Unweighted" = 3, "IIW" = 3, "IPTW" = 3, "MIPIW" = 3))
