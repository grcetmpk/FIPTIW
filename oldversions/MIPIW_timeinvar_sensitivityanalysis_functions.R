...
### NOTE: looking at what happens when we *know* the censoring pattern
...
gendataMIPI_timeinvar_SENS <- function(n, beta1, beta2, beta3, 
  ...
  colnames(simdatafull) <- c("id", "time", "G", "W", "Z", "censortime", "cexp_W_G", "cexp_Z_G",  "y", "notcensored")
...
simulateOneMIPI_timeinvar_SENS <- function(n, beta1, beta2, beta3, 
                                           gamma1, gamma2, gamma3, 
                                           kappa1, kappa2, kappa3, 
                                           alpha0, alpha1, tau){
  ...
  singlerun <- gendataMIPI_timeinvar_SENS(n, beta1, beta2, beta3, 
                                          gamma1, gamma2, gamma3, 
                                          kappa1, kappa2, kappa3, 
                                          alpha0, alpha1, tau)
